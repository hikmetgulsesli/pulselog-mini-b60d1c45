...
- PulseLog Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact single-page tool called PulseLog Mini. It should show a status summary, an event list, a filter bar, and a details drawer. Use plain HTML, CSS, and JavaScript only, persist state in localStorage, and include clear empty, error, and recovery states.
...
- Record Operations - PulseLog Mini
- Record Editor - PulseLog Mini
- Insights - PulseLog Mini
- Settings and Preferences - PulseLog Mini
- Empty and Error Recovery - PulseLog Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - PulseLog Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - PulseLog Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - PulseLog Mini
...
SCREEN_SPEC_4:
- exact_screen_title: Settings and Preferences - PulseLog Mini
...
SCREEN_SPEC_5:
- exact_screen_title: Empty and Error Recovery - PulseLog Mini
